    ...
    private void bindViews()
    {
        ...
        mFab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    BleManager.getInstance().transmitBlePacketData(com.clexi.hio.bluetoothle.Consts.UUID_CHARACTERISTIC_CLEXI_REQUEST, new byte[]{
                            (byte) 0xC0,
                            (byte) 0x00,
                            (byte) 0x00,
                            (byte) 0x07,
